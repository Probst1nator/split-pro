  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {showFriends || (1 === participants.length && !group) ? (
        ...
        <>
          {/* Not while editing: the Scan tab only ever creates new expenses, so it would
              leave the edited one untouched and add unrelated ones alongside it. */}
          {receiptScanEnabled && !expenseId ? (

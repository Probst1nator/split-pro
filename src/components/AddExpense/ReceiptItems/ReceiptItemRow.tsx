...
export const ReceiptItemRow: React.FC<{
  ...
  /* Derived from the item's currency so 0-decimal (JPY) and 3-decimal (BHD) render correctly. */
  const amountPlaceholder = getCurrencyHelpersCached(item.currency).toUIString(0n, false, true);
  ...
  return (
    <div className="flex items-center gap-2 py-1">
      ...
      <Input
        ...
        placeholder={t('expense_details.add_expense_details.receipt_items.item_placeholder')}
      />

...
describe('parseReceiptItemsResponse (line-items mode)', () => {
  ...
  /*
   * JSON.parse accepts these without throwing, so an unguarded parser would property-access
   * a non-object and raise a TypeError instead of degrading to an empty list.
   */

...
#
# Results that produced PREFERRED_OLLAMA_MODELS in receiptScanService.ts, over three receipts
# (a clean render, a glare-lit photo of a curled receipt, a crumpled low-contrast photo),
# two runs each. Re-run this script to re-rank.
#
#   Model                            Amount recall  Spurious  Verdict
#   gemini-3.5-flash-lite (cloud)    24/24          0         reference
#   gemma4:e4b                       16/16          0         best local
#   gemma4:e2b                       22/24          1         good cheap tier
#   minicpm-v4.5:8b                  24/24          0         rejected: fabricated the date
#                                                             in 4 of 6 runs
#   medgemma1.5:4b                   20/24          7         rejected: returns totals and
#                                                             savings lines as line items
#   nemotron3:33b                    13/24          0         rejected: reasoning model, empty
#                                                             content, minutes per scan
#   qwen3.6:27b                      10/16          0         rejected: same failure, ~500s/run
#   minicpm-v4.6:1b                   9/24          0         rejected: empty or invalid JSON
